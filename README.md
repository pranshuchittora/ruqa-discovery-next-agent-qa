...
+ **[Agent QA](https://vostride.com/docs/agent-qa)**: Инструмент для тестирования веб-приложений, Android и iOS по сценариям на естественном языке; CLI, веб-панель и MCP. Исходный код доступен по FSL-1.1-ALv2; расходы на модели и инфраструктуру оплачиваются отдельно. Документация на английском.
